...
GRAMMAR = {
    ...
    "Return_Value": ["Expression #return_value", "EPSILON"],
    ...
    "If_stmt": ["if Relational_Expression #save_cond : Statements Else_block"],
    "Else_block": ["else #if_save : Statements #else", "EPSILON #if"],
    "Iteration_stmt": ["while #label ( Relational_Expression ) #save_cond Statements #while"],
    ...
    "Primary": ["[ Expression ] Primary", "( Arguments ) #call_func #push_returned_value Primary", "EPSILON"],
